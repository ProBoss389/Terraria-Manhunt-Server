...
public class InGamePopups
{
	public class AchievementUnlockedPopup : IInGameNotification
	{
		...
		public AchievementUnlockedPopup(Achievement achievement)
		{
			...
			_achievementTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievements");
			_achievementBorderTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders");
		}
	...
	public class PlayerWantsToJoinGamePopup : IInGameNotification
	{
		...
		public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
		{
			...
			if (opacity > 0f)
			{
				...
				vector.X += 32f;
				Texture2D value = Main.Assets.Request<Texture2D>("Images/UI/ButtonPlay", AssetRequestMode.ImmediateLoad).Value;
				...
				value = Main.Assets.Request<Texture2D>("Images/UI/ButtonDelete", AssetRequestMode.ImmediateLoad).Value;
