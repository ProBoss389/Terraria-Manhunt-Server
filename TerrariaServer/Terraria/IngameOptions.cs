...
public static class IngameOptions
{
	...
	public static void Draw(Main mainInstance, SpriteBatch sb)
	{
		...
		if (category == 1)
		{
			...
			}, num16, vector6, vector7, rightScale[num16], (rightScale[num16] - num4) / (num5 - num4)))
			{
				rightHover = num16;
				if (flag4)
				{
			...
			if (DrawRightSide(sb, txt, num16, vector6, vector7, rightScale[num16], (rightScale[num16] - num4) / (num5 - num4)))
			{
				rightHover = num16;
				if (flag4)
				{
		...
		if (category == 2)
		{
			...
			num18++;
			if (DrawRightSide(sb, Language.GetTextValue("GameUI.ForegroundSunlightEffects", Main.ForegroundSunlightEffects ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num18, vector6, vector7, rightScale[num18], (rightScale[num18] - num4) / (num5 - num4)))
			{
				rightHover = num18;
				if (flag4)
				{
			...
			num18++;
			if (DrawRightSide(sb, Language.GetTextValue("GameUI.ScreenShake", Main.UseScreenShake ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num18, vector6, vector7, rightScale[num18], (rightScale[num18] - num4) / (num5 - num4)))
			{
				rightHover = num18;
				if (flag4)
				{
		...
		if (category == 3)
		{
			...
			if (DrawRightSide(sb, txt2, num21, vector6, vector7, rightScale[num21] * 0.9f, (rightScale[num21] - num4) / (num5 - num4)))
			{
				rightHover = num21;
				if (flag4)
				{
