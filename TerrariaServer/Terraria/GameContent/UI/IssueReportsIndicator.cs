...
public class IssueReportsIndicator
{
	...
	private void Setup()
	{
		_buttonTexture = Main.Assets.Request<Texture2D>("Images/UI/Workshop/IssueButton", AssetRequestMode.ImmediateLoad);
		_buttonOutlineTexture = Main.Assets.Request<Texture2D>("Images/UI/Workshop/IssueButton_Outline", AssetRequestMode.ImmediateLoad);
	}
