...
public class NPCStatsReportInfoElement : IBestiaryInfoElement, IUpdateBeforeSorting
{
	...
	public UIElement ProvideUIElement(BestiaryUICollectionInfo info)
	{
		...
		int num3 = 3;
		int num4 = 0;
		UIImage uIImage = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_HP", AssetRequestMode.ImmediateLoad))
		{
			Top = new StyleDimension(num4, 0f),
			Left = new StyleDimension(num3, 0f)
		};
		UIImage uIImage2 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Attack", AssetRequestMode.ImmediateLoad))
		{
			Top = new StyleDimension(num4 + num2, 0f),
			Left = new StyleDimension(num3, 0f)
		};
		UIImage uIImage3 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Defense", AssetRequestMode.ImmediateLoad))
		{
			Top = new StyleDimension(num4 + num2, 0f),
			Left = new StyleDimension(num3 + num, 0f)
		};
		UIImage uIImage4 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Knockback", AssetRequestMode.ImmediateLoad))
		{
			Top = new StyleDimension(num4, 0f),
			Left = new StyleDimension(num3 + num, 0f)
		};
		...
		if (num7 > 0)
		{
			...
			int num10 = num8 + 8;
			int num11 = 49;
			UIImage uIImage5 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Platinum", AssetRequestMode.ImmediateLoad))
			{
				Top = new StyleDimension(num10, 0f),
				Left = new StyleDimension(num9, 0f)
			};
			UIImage uIImage6 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Gold", AssetRequestMode.ImmediateLoad))
			{
				Top = new StyleDimension(num10, 0f),
				Left = new StyleDimension(num9 + num11, 0f)
			};
			UIImage uIImage7 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Silver", AssetRequestMode.ImmediateLoad))
			{
				Top = new StyleDimension(num10, 0f),
				Left = new StyleDimension(num9 + num11 * 2 + 1, 0f)
			};
			UIImage uIImage8 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Copper", AssetRequestMode.ImmediateLoad))
			{
				Top = new StyleDimension(num10, 0f),
