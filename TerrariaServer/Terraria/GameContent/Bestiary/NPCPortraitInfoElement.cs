...
public class NPCPortraitInfoElement : IBestiaryInfoElement
{
	...
	private UIElement CreateStarsContainer()
	{
		...
		UIElement uIElement = new UIPanel(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Panel", AssetRequestMode.ImmediateLoad), null, 5, 21)
		{
		...
		for (int num10 = num5 - 1; num10 >= 0; num10--)
		{
			...
			UIImage element = new UIImage(Main.Assets.Request<Texture2D>(assetName, AssetRequestMode.ImmediateLoad))
			{
