...
public class TilePaintSystemV2
{
	...
	public class TreeTopRenderTargetHolder : ARenderTargetHolder
	{
		...
		{
			Asset<Texture2D> asset = Main.Assets.Request<Texture2D>(TextureAssets.TreeTop[Key.TextureIndex].Name, AssetRequestMode.ImmediateLoad);
	...
	public class TreeBranchTargetHolder : ARenderTargetHolder
	{
		...
		public override void Prepare()
		{
			Asset<Texture2D> asset = Main.Assets.Request<Texture2D>(TextureAssets.TreeBranch[Key.TextureIndex].Name, AssetRequestMode.ImmediateLoad);
			PrepareTextureIfNecessary(asset.Value);
		}
	...
	public class TileRenderTargetHolder : ARenderTargetHolder
	{
		...
		public override void Prepare()
		{
			Asset<Texture2D> asset = Main.Assets.Request<Texture2D>(TextureAssets.Tile[Key.TileType].Name, AssetRequestMode.ImmediateLoad);
			PrepareTextureIfNecessary(asset.Value);
		}
	...
	public class WallRenderTargetHolder : ARenderTargetHolder
	{
		...
		public override void Prepare()
		{
			Asset<Texture2D> asset = Main.Assets.Request<Texture2D>(TextureAssets.Wall[Key.WallType].Name, AssetRequestMode.ImmediateLoad);
			PrepareTextureIfNecessary(asset.Value);
		}
