...
public class NebulaSky : CustomSky
{
	...
	{
		_planetTexture = Main.Assets.Request<Texture2D>("Images/Misc/NebulaSky/Planet", AssetRequestMode.ImmediateLoad);
		_bgTexture = Main.Assets.Request<Texture2D>("Images/Misc/NebulaSky/Background", AssetRequestMode.ImmediateLoad);
		_beamTexture = Main.Assets.Request<Texture2D>("Images/Misc/NebulaSky/Beam", AssetRequestMode.ImmediateLoad);
		_rockTextures = new Asset<Texture2D>[3];
		for (int i = 0; i < _rockTextures.Length; i++)
		{
			_rockTextures[i] = Main.Assets.Request<Texture2D>("Images/Misc/NebulaSky/Rock_" + i, AssetRequestMode.ImmediateLoad);
		}
	}
