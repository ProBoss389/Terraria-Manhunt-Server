...
public class SolarSky : CustomSky
{
	...
	{
		_planetTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Planet", AssetRequestMode.ImmediateLoad);
		_bgTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Background", AssetRequestMode.ImmediateLoad);
		_meteorTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Meteor", AssetRequestMode.ImmediateLoad);
	}
