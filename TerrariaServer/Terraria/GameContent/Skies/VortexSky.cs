...
public class VortexSky : CustomSky
{
	...
	{
		_planetTexture = Main.Assets.Request<Texture2D>("Images/Misc/VortexSky/Planet", AssetRequestMode.ImmediateLoad);
		_bgTexture = Main.Assets.Request<Texture2D>("Images/Misc/VortexSky/Background", AssetRequestMode.ImmediateLoad);
		_boltTexture = Main.Assets.Request<Texture2D>("Images/Misc/VortexSky/Bolt", AssetRequestMode.ImmediateLoad);
		_flashTexture = Main.Assets.Request<Texture2D>("Images/Misc/VortexSky/Flash", AssetRequestMode.ImmediateLoad);
	}
