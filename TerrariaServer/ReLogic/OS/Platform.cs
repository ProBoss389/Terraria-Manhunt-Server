...
public abstract class Platform : IDisposable
{
	...
	public static T Get<T>() where T : class => Current._services.Get<T>();
	public static bool Has<T>() where T : class => Current._services.Has<T>();
	...
	public static U IfHas<T, U>(Func<T, U> callback) where T : class => Current._services.IfHas(callback);
