...
public struct Vector2D : IEquatable<Vector2D>
{
	...
	public static Vector2D Barycentric(Vector2D value1, Vector2D value2, Vector2D value3, double amount1, double amount2) => new Vector2D(Barycentric(value1.X, value2.X, value3.X, amount1, amount2), Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2));
	...
	public static Vector2D CatmullRom(Vector2D value1, Vector2D value2, Vector2D value3, Vector2D value4, double amount) => new Vector2D(CatmullRom(value1.X, value2.X, value3.X, value4.X, amount), CatmullRom(value1.Y, value2.Y, value3.Y, value4.Y, amount));
	...
	public static Vector2D Clamp(Vector2D value1, Vector2D min, Vector2D max) => new Vector2D(Clamp(value1.X, min.X, max.X), Clamp(value1.Y, min.Y, max.Y));
	...
	public static Vector2D Lerp(Vector2D value1, Vector2D value2, double amount) => new Vector2D(Lerp(value1.X, value2.X, amount), Lerp(value1.Y, value2.Y, amount));
	...
	public static Vector2D Max(Vector2D value1, Vector2D value2) => new Vector2D((value1.X > value2.X) ? value1.X : value2.X, (value1.Y > value2.Y) ? value1.Y : value2.Y);
	...
	public static Vector2D Min(Vector2D value1, Vector2D value2) => new Vector2D((value1.X < value2.X) ? value1.X : value2.X, (value1.Y < value2.Y) ? value1.Y : value2.Y);
	...
	public static Vector2D SmoothStep(Vector2D value1, Vector2D value2, double amount) => new Vector2D(SmoothStep(value1.X, value2.X, amount), SmoothStep(value1.Y, value2.Y, amount));
	...
	public static double Barycentric(double value1, double value2, double value3, double amount1, double amount2) => value1 + (value2 - value1) * amount1 + (value3 - value1) * amount2;
