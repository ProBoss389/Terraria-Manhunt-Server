...
public struct GlyphMetrics
{
	...
	public static GlyphMetrics FromKerningData(float leftPadding, float characterWidth, float rightPadding) => new GlyphMetrics(leftPadding, characterWidth, rightPadding);
}
